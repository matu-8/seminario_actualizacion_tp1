...
```
2-Abrir un terminal en la carpeta de repositorio clonado y seleccionar entre implementacion_2 (Servidor Javascript) o implementacion_3 (servidor python)
```bash
cd seminario_actualizacion_tp1
cd implementacion_2
cd implementacion_3
```
...
node server.js
```
4-En el caso de la implementacion_3, se realiza algo similar para levantar el servidor con python:
```bash
python server.py
```
